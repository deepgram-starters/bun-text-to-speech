...
Bun demo app for Deepgram Text-to-Speech.
...
```
feat(bun-text-to-speech): add diarization support
fix(bun-text-to-speech): resolve WebSocket close handling
refactor(bun-text-to-speech): simplify session endpoint
